...
const Header = () => {
  ...
  const totalCartItems = useSelector((store) => store.cart.totalCartItems);
  return (
    <div className="flex w-full justify-between border border-black bg-yellow-300 align-middle">
      <div className="w-28">
